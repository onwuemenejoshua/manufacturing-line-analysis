...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'DowntimeFactors')
BEGIN
    CREATE TABLE [dbo].[DowntimeFactors](
        [Factor] [int] NOT NULL,
        [Description] [nvarchar](100) NOT NULL,
        [Operator_Error] [nvarchar](3) NOT NULL,
        CONSTRAINT [PK_DowntimeFactors] PRIMARY KEY CLUSTERED ([Factor])
    )
END

IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'LineDowntimeWide')
BEGIN
    CREATE TABLE [dbo].[LineDowntimeWide](
        [Batch] [int] NOT NULL,
        [F1] [int] NULL,
        [F2] [int] NULL,
        [F3] [int] NULL,
        ...
        [F11] [int] NULL,
        [F12] [int] NULL,
        CONSTRAINT [PK_LineDowntimeWide] PRIMARY KEY CLUSTERED ([Batch])
    )
END


IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'LineProductivity')
BEGIN
    CREATE TABLE [dbo].[LineProductivity](
        [Date] [date] NOT NULL,
        ...
        CONSTRAINT [PK_LineProductivity] PRIMARY KEY CLUSTERED ([Batch])
    )
END
...
BEGIN
    CREATE TABLE [dbo].[Products](
        ...
        CONSTRAINT [PK_Products] PRIMARY KEY CLUSTERED ([Product])
    )
END
